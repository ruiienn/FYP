...
public class MemberController {
	...
	public String saveMember(@Valid Member member, BindingResult bindingResult, Model model, RedirectAttributes redirectAttributes) {
	    ...
	    redirectAttributes.addFlashAttribute("success", "Member successfully added!");
	    return "redirect:/members"; // Redirect to view_members page
	}
